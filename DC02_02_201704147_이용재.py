...
def parsing_tcp_header(data):
  ...
  print("| >> reserved ->", int(slicing_flags[4:6], 2)) 
  print("| >> nonce ->", int(slicing_flags[7], 2))
  print("| >> cwr ->", int(slicing_flags[8], 2))
  print("| >> ecr ->", int(slicing_flags[9], 2))
  print("| >> urgent ->", int(slicing_flags[10], 2))
  print("| >> ack ->", int(slicing_flags[11], 2))
  print("| >> push ->", int(slicing_flags[12], 2))
  print("| >> reset ->", int(slicing_flags[13], 2))
  print("| >> syn ->", int(slicing_flags[14], 2))
  print("| >> fin ->", int(slicing_flags[15], 2))
